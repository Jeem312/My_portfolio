...
import { FaLink, FaUnlockAlt } from 'react-icons/fa';
  ...
  return (
    <div className="my-10 px-4">
      ...
      <div className="my-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8 h-full">
          {teamProjects.map((project) => (
            <div key={project.id} className="block border border-gray-200 h-[650px] rounded-lg shadow transition duration-300 hover:scale-105">
              ...
              <div className="p-4">
                ...
                <div className="flex justify-between mt-4 mb-10 pb-8">
                  <div className="flex space-x-4 w-full">
                    <button
                      className="border border-gray-300 text-white py-2 px-4 rounded flex items-center space-x-2 hover:bg-blue-600 w-full"
                    ...
                    <a
                      ...
                      className="border border-gray-300 text-white py-2 px-4 rounded flex items-center space-x-2 hover:bg-green-600 w-full"
                    >
      ...
      <div className="mt-12">
        ...
        <div className='border border-gray-300 my-4 h-ful'></div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 my-4 h-full">
          {soloProjects.map((project) => (
            <div key={project.id} className="block border border-gray-200 h-[530px] rounded-lg shadow transition duration-300 hover:scale-105">
              <img src={project.image} alt={project.name} className="w-full h-1/2 object-cover rounded-lg" />
              <div className="p-4">
                <h2 className="text-xl font-semibold text-white mb-2">{project.name}</h2>
                <p className="text-gray-500 mb-2">{project.overview}</p>
                ...
                <div className="flex justify-between mt-4 mb-10 pb-8">
                  <div className="flex space-x-4 w-full">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="border border-gray-300 text-white py-2 px-4 rounded flex items-center space-x-2 hover:bg-indigo-600 w-full"
                    >
                      <FaLink /> <span>Live Link</span>
                    </a>
                  </div>
