       ...
       <div className='container mx-auto'>
         <div className='flex flex-col md:flex-row gap-4'>
           <div className='flex-1'>
            ...
            <p className='text-xl my-12 text-start'>I'm a passionate front-end developer who builds delightful web experiences. With a strong foundation in React.js, HTML, and CSS, I create engaging and user-friendly interfaces.</p>
            <p className='text-xl text-start'>Even as a fresher, my enthusiasm for web development drives me to continuously learn and stay updated with the latest technologies and best practices. I specialize in crafting responsive and accessible web applications that not only look great but also perform efficiently.</p>
           </div> 
           <div className='flex-1'>
        ...
        <div>
          <p className='text-xl my-12 text-start'>I have experience working with MongoDB for database management, React Router for seamless navigation, and implementing various payment methods. For authentication, I rely on Firebase to ensure secure and reliable user access.</p>
