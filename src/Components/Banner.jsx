...
import { FaDownload, FaEnvelope, FaFacebook, FaGithub, FaLinkedin, FaPhone } from 'react-icons/fa';
    ...
    return (
       <div className='container mx-auto '>
        ...
        <div className='my-12 flex justify-start'>
            <button className='btn bg-[#FF5400] text-white '><FaDownload></FaDownload> Download CV</button>
        </div>
