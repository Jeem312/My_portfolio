        ...
        <div className="hero">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div className='flex-1'>
                    <h1 className='flex justify-start text-3xl font-bold text-blue-800'>
                        <FaGraduationCap className='h-10 w-10' />Education
                    </h1>
                    <div className='my-6'>
                    ...
                    <div className='my-6'>
                        ...
                        <p className='text-start'>I have completed a Junior Web Development course from the Programming Hero online platform. This comprehensive program covered essential web development technologies and tools, including HTML, CSS, JavaScript, and React.js. The course also provided hands-on experience with MongoDB for database management, React Router for navigation, and Firebase for authentication. This practical training has been crucial in building my capabilities as a front-end developer.</p>
                    </div>
                    <div className='my-6'>
                        <p className='text-blue-500 font-bold text-start'>Completed: Presentation and Public Speaking Course from 10 Minute School</p>
                        <p className='text-start'>I have completed a Presentation and Public Speaking course from 10 Minute School. This course provided practical insights and techniques for delivering engaging and impactful presentations. It helped me enhance my communication skills, boost confidence in public speaking, and learn strategies for audience engagement, all of which are valuable skills for professional and personal growth.</p>
                    </div>
                </div>
            </div>
        </div>
